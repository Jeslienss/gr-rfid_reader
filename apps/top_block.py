...
# Title: Top Block
# Generated: Tue Sep 10 18:53:34 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.rfid_reader_reader_0, 0))
        ...
        self.connect((self.rfid_reader_reader_0, 0), (self.blocks_throttle_0, 0))
